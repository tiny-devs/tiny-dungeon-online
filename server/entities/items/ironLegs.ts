...
export default class IronLegs extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, Items.IronLegs, ItemType.Weareable, GearType.Legs, 0, 0, 20, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.IronLegs), sellPrice.IronLegs)
    }
}