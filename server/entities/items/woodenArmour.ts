...
export default class WoodenArmour extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, ItemsIds.WoodenArmour, ItemType.Weareable, GearType.Torso, 0, 0, 1, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.WoodenArmour), sellPrice.WoodenArmour)
    }
}