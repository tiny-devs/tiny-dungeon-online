...
export default class WoodenDagger extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, ItemsIds.WoodenDagger, ItemType.Weareable, GearType.Weapon, 0, 0, 1, false, 1, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.WoodenDagger), sellPrice.WoodenDagger)
    }
}