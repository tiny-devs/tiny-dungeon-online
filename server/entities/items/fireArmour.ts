...
export default class FireArmour extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, Items.FireArmour, ItemType.Weareable, GearType.Torso, 0, 0, 50, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.FireArmour), sellPrice.FireArmour)
    }
}