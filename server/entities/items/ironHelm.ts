...
export default class IronHelm extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, ItemsIds.IronHelm, ItemType.Weareable, GearType.Head, 0, 0, 20, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.IronHelm), sellPrice.IronHelm)
    }
}