...
export default class BluriteLegs extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, Items.BluriteLegs, ItemType.Weareable, GearType.Legs, 0, 0, 30, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.BluriteLegs), sellPrice.BluriteLegs)
    }
}