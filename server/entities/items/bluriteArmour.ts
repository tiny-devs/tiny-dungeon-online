...
export default class BluriteArmour extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, ItemsIds.BluriteArmour, ItemType.Weareable, GearType.Torso, 0, 0, 30, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.BluriteArmour), sellPrice.BluriteArmour)
    }
}