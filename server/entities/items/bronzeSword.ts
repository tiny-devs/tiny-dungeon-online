...
export default class BronzeSword extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, Items.BronzeSword, ItemType.Weareable, GearType.Weapon, 0, 0, 10, false, 0, 1, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.BronzeSword), sellPrice.BronzeSword)
    }
}