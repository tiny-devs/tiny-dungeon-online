...
export default class WoodenHelm extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, Items.WoodenHelm, ItemType.Weareable, GearType.Head, 0, 0, 1, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.WoodenHelm), sellPrice.WoodenHelm)
    }
}