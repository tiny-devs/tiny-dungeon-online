...
export default class AdamantLegs extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, ItemsIds.AdamantLegs, ItemType.Weareable, GearType.Legs, 0, 0, 40, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.AdamantLegs), sellPrice.AdamantLegs)
    }
}