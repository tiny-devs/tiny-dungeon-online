...
export default class AdamantArmour extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, ItemsIds.AdamantArmour, ItemType.Weareable, GearType.Torso, 0, 0, 40, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.AdamantArmour), sellPrice.AdamantArmour)
    }
}