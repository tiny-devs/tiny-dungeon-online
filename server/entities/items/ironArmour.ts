...
export default class IronArmour extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, ItemsIds.IronArmour, ItemType.Weareable, GearType.Torso, 0, 0, 20, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.IronArmour), sellPrice.IronArmour)
    }
}