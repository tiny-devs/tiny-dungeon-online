...
export default class SmallHp extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, ItemsIds.SmallHp, ItemType.Consumable, GearType.None, 0, 0, 0, false, 0, 0, 15, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.SmallHp), sellPrice.SmallHp)
    }
}