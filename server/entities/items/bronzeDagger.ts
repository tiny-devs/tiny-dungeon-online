...
export default class BronzeDagger extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, Items.BronzeDagger, ItemType.Weareable, GearType.Weapon, 0, 0, 10, false, 1, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.BronzeDagger), sellPrice.BronzeDagger)
    }
}