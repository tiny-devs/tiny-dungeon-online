...
export default class BronzeHelm extends ItemBase {
    ...
    constructor(dropChance: number, customBuyPrice: number = 0) {
        super(0, Items.BronzeHelm, ItemType.Weareable, GearType.Head, 0, 0, 10, true, 0, 0, 0, dropChance, (customBuyPrice !== 0 ? customBuyPrice : buyPrice.BronzeHelm), sellPrice.BronzeHelm)
    }
}