...
export default class SkeletonKnight extends NpcBase {
    constructor() {
        super(Npcs.SkeletonKnight, true, 'skeleton knight', 0, 0, 0, 25, 10000, 0.15, 6, 36, null, [new IronDagger(0.2),new IronSword(0.1),new IronHelm(0.3),new BronzeHelm(0.7),new BronzeLegs(0.7),new Coffee(0.4)], null)
    }
}