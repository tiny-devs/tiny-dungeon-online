...
import JamulsMachete from "../items/jamulsMachete.ts"

export default class Zombie extends NpcBase {
    constructor() {
        super(Npcs.Zombie, true, 'zombie', 0, 0, 0, 45, 10000, 0.25, 6, 36, null, [new JamulsMachete(0.1), new AdamantHelm(0.1), new BluriteArmour(0.3), new BluriteHelm(0.4), new BluriteDagger(0.8)], null)
    }
}