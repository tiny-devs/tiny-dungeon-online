...
export default class Ligneus extends NpcBase {
    constructor() {
        super(Npcs.Ligneus, true, 0, 0, 0, 15, 10000, 0.15, 8, 36, null, [new WoodenDagger(0.7),new WoodenSword(0.7),new WoodenArmour(0.7),new BronzeDagger(0.1),new Coffee(0.5)])
    }
}