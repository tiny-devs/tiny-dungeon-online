...
export default class Plains6 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.River9, -1, Rooms.River7, Rooms.Plains7), clientHandler)
    this.solidLayer = SolidLayers.Plains6
