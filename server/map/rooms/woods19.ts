...
export default class Woods19 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Woods15, Rooms.Woods23, Rooms.Woods18, Rooms.Woods20), clientHandler)
    this.solidLayer = SolidLayers.Woods19
