...
export default class Woods11 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Woods2, Rooms.Woods16, Rooms.Woods10, Rooms.Gnomes1), clientHandler)
    this.solidLayer = SolidLayers.Woods11
