...
export default class Plains8 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Plains4, -1, Rooms.Plains7, Rooms.Plains9), clientHandler)
    this.solidLayer = SolidLayers.Plains8
