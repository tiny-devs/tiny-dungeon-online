...
export default class Plains5 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Plains2, Rooms.Plains9, Rooms.Plains4, -1), clientHandler)
    this.solidLayer = SolidLayers.Plains5
