...
export default class Woods17 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Woods12, Rooms.River8, Rooms.Gnomes4, Rooms.River10), clientHandler)
    this.solidLayer = SolidLayers.Woods17
