...
export default class Plains1 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.DeepLake, -1, Rooms.River11, Rooms.Plains2), clientHandler)
    this.solidLayer = SolidLayers.Plains1
