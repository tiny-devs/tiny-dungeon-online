...
export default class River10 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Woods13, Rooms.River9, Rooms.Woods17, Rooms.River11), clientHandler)
    this.solidLayer = SolidLayers.River10
