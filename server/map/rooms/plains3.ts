...
export default class Plains3 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.River11, Rooms.Plains7, Rooms.River9, Rooms.Plains4), clientHandler)
    this.solidLayer = SolidLayers.Plains3
