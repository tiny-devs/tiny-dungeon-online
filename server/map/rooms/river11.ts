...
export default class River11 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.River12, -1, Rooms.River10, Rooms.Plains1), clientHandler)
    this.solidLayer = SolidLayers.River11
