...
export default class Woods20 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Woods16, Rooms.River4, Rooms.Woods19, Rooms.Woods21), clientHandler)
    this.solidLayer = SolidLayers.Woods20
