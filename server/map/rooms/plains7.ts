...
export default class Plains7 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Plains3, -1, Rooms.Plains6, Rooms.Plains8), clientHandler)
    this.solidLayer = SolidLayers.Plains7
