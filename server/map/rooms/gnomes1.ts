...
export default class Gnomes1 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Woods3, -1, Rooms.Woods11, Rooms.Gnomes2), clientHandler)
    this.solidLayer = SolidLayers.Gnomes1
