...
export default class GoblinCamp extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Woods16, -1, Rooms.Woods19, Rooms.Woods21), clientHandler)
    this.solidLayer = SolidLayers.GoblinCamp
