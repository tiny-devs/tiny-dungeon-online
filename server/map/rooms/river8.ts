...
export default class River8 extends Room{
  constructor(id: number, clientHandler: ClientHandler) {
    super (id, new Exits(Rooms.Woods17, Rooms.River7, Rooms.Woods22, Rooms.River9), clientHandler)
    this.solidLayer = SolidLayers.River8
